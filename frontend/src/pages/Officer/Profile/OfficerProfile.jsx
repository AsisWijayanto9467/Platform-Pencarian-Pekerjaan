...
export default function OfficerProfile() {
  ...
  const fetchProfile = async () => {
    try {
      setLoading(true);
      // Officer menggunakan endpoint yang sama dengan validator
      ...
      <MainLayouts>
        <div className="d-flex justify-content-center align-items-center" style={{ minHeight: '60vh' }}>
          <div className="text-center">
            ...
            <p className="text-muted">Memuat data profil officer...</p>
          </div>
        </div>
      </MainLayouts>
    );
  ...
  return (
    <MainLayouts>
      <div className="container-fluid px-0">
        ...
        {/* Header Gradient - Selalu Orange untuk Officer */}
                ...
                <div className="d-flex align-items-center justify-content-between">
                  <div>
                    ...
                    <p className="text-white-50 mb-0" style={{ fontSize: '0.95rem' }}>
                      Kelola informasi profil Officer Anda
                    </p>
                  </div>
          ...
          <div className="col-lg-4 mb-4">
            <div className="card border-0 shadow-sm" style={{ borderRadius: '12px' }}>
              <div className="card-body text-center p-4">
                ...
                >
                  <i className="fas fa-user-tie" style={{ fontSize: '40px', color: '#e67e22' }}></i>
                </div>
              ...
              <div className="card-header bg-white border-0 pt-4 pb-3" style={{ borderRadius: '12px 12px 0 0' }}>
                <div className="d-flex justify-content-between align-items-center">
                  <h6 className="mb-0 fw-bold" style={{ color: '#2c3e50', fontSize: '1rem' }}>
                    ...
                    {isEditing ? 'Edit Profil Officer' : 'Informasi Profil Officer'}
                  </h6>
                  {!isEditing ? (
                    <button 
                    ...
                    <div className="row">
                      <div className="col-md-6">
                        <div className="form-group">
                          <label>
                            <i className="fas fa-user mr-1" style={{ color: '#e67e22' }}></i>
                ...
                <div className="row">
                  <div className="col-md-4 mb-3">
                    <div className="d-flex align-items-center">
                      ...
                      >
                        <i className="fas fa-lock" style={{ color: '#e67e22', fontSize: '18px' }}></i>
                      </div>
                      <div>
                  ...
                  <div className="col-md-4 mb-3">
                    <div className="d-flex align-items-center">
                      ...
                      >
                        <i className="fas fa-history" style={{ color: '#e67e22', fontSize: '18px' }}></i>
                      </div>
                      <div>
